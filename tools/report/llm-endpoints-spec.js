...
const LLM_ENDPOINT_SPECS = [
  {
    endpoint: "/get-models",
    kind: "callApi",
    meaning: "Fetch available models/feature flags (and inject BYOK models registry)",
  ...
  },
  {
    endpoint: "/chat",
    kind: "callApi",
    meaning: "Non-streaming chat (or chat in some scenarios)",
  ...
  },
  {
    ...
    kind: "callApi",
    meaning: "Smart completion in chat input box",
    upstreamBackType: "BackCompletionResult",
  ...
  },
  {
    ...
    kind: "callApi",
    meaning: "Next Edit location (candidate positions JSON)",
  ...
  },
  {
    ...
    kind: "callApiStream",
    meaning: "Instruction generation/rewrite (stream)",
  ...
  },
  {
    ...
    kind: "callApiStream",
    meaning: "Next Edit suggestions (stream)",
